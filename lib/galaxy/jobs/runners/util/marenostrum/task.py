...
# Job submission
    def set_local_file(self, local_data_filepath):
        self.task_data['local_data_bundle'] = DataBundle(self.id)
        self.task_data['local_data_bundle'].add_file(local_data_filepath)
        self.modified = True
...
#        print("TASK: opening ssh session")
        ...
        return self.task_data['remote_job_id']
...
# Output data management
    ...
    def _remote_wdir(self):
        ...
        return self.task_data['remote_base_path'] + '/' # + self.id
